...
from routes import user_info_bp, token_information_bp, versions, shop_bp, computed_products_bp, feedback_bp
...
app_server.register_blueprint(feedback_bp.feedback_bp, url_prefix='/feedback')
